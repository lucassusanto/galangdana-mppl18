...
<form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="{{ url('/galang/'. Auth::user()->id.'/upload') }}" style="margin:150px 0">
{{ csrf_field() }}
<div class="container reg-campaign-box" style="margin-top: 100px; width: 55%;">
  <div class="form-group">
    <label for="form-label col--m4">Judul Kegiatan</label>
    <input type="text" class="form-control" id="JudulCampaign" placeholder="Judul Campaign" name="nama_kegiatan" required autofocus>
  </div>
  <div class="form-group">
    <label for="form-label col--m4">Target Dana</label>
    <input type="text" class="form-control" id="TargetDana" placeholder="Target Dana" name="uang_target" required autofocus>
  </div>
  <div class="form-group">
    <label for="form-label col--m4">Deadline Kegiatan</label>
    <input type="date" class="form-control" id="DeadlineCampaign" placeholder="Deadline Campaign" name="deadline" required autofocus>
  </div>
  <div class="form-group">
  ...
  <div class="form__row col">
            ...
            <div class="input-col col--m8">
                  ...
                  <textarea rows="2" maxlength="240" class="form-input form-input--block input-max-char" name="deskripsi" id="Projects_short_description" required autofocus></textarea>
            </div>
   </div>
