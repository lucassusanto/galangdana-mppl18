<!-- header start -->
<!-- ================ --> 
@if (Request::is('home') || Request::path() == '/')
    <header class="header fixed clearfix navbar navbar-fixed-top">        
@else
    <header style="background-color: black;" class="header fixed clearfix navbar navbar-fixed-top">
@endif
        ...
        <div class="col-md-4">
            ...
            <div class="header-left clearfix">
                ...
                <div class="logo smooth-scroll">
                    <a href="{{ url('/') }}"><img id="logo" src="{{ asset('images/gd.png') }}" alt="Worthy"></a>
                </div>

                <!-- name-and-slogan -->
                <div class="site-name-and-slogan smooth-scroll">
                    <div class="site-name"><a href="{{ url('/') }}">GalangDana</a></div>
                    <div class="site-slogan">Peduli sesama!</div>
                </div>
